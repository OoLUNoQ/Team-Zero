...
$output .= '@media only screen and (max-width:'. ((int)$vars['medium_responsive_breakpoint'] - 1) .'px) {';
	...
	$output .= '.single-folio.folio_inside_2 .folio-info.desc-right {';
		...
		$output .= 'clear: both;';
	$output .= '}';
	$output .= '.single-folio.folio_inside_1 .folio-info.desc-left>.row,';
	$output .= '.single-folio.folio_inside_1 .folio-info.desc-right>.row,';
	$output .= '.single-folio.folio_inside_2 .folio-info.desc-left>.row,';
	$output .= '.single-folio.folio_inside_2 .folio-info.desc-right>.row {';
