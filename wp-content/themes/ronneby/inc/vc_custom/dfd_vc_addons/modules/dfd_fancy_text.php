...
//							'dependency'  => array( 'element' => 'style', 'value' => array( 'typed', 'changethewords' ) ),
		...
		function dfd_animated_text_shortcode( $atts, $content = null ) {
			...
			//My 
			$prefix_postfix_responsive = $text_responsive = '';
			global $dfd_ronneby;
...
//					break;
			...
			if(isset($prefix_postfix_responsive) && $prefix_postfix_responsive != '') {
				$css_rules .= Dfd_Resposive_Text_Param::responsive_css($prefix_postfix_responsive, '#' . esc_js($uniqid) . '.dfd-animated-text-wrap .dfd-animated-text-block span.dfd-animate-text span, #' . esc_js($uniqid) . '.dfd-animated-text-wrap .dfd-animated-text-block span.dfd-animate-me');
			}
			if(isset($text_responsive) && $text_responsive != '') {
				$css_rules .= Dfd_Resposive_Text_Param::responsive_css($text_responsive, '#' . esc_js($uniqid) . '.dfd-animated-text-wrap .dfd-animated-text-block span, #' . esc_js($uniqid) . '.dfd-animated-text-wrap .dfd-animated-text-block span');
			}
