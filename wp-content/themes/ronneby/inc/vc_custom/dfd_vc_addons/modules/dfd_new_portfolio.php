...
if(!class_exists('Dfd_Portfolio_Module')) {
	class Dfd_Portfolio_Module {
					...
					array(
						...
						'params' => array(
							...
							*/
							...
							array(
								'type'				=> 'colorpicker',
								'heading'			=> esc_html__('Hover mask background', 'dfd' ),
								'param_name'		=> 'mask_background',
								'edit_field_class'	=> 'vc_column crum_vc vc_col-sm-12',
		...
		function dfd_portfolio_module_shortcode($atts) {
			$output = $title_html = $data_atts = $article_data_atts = $css_rules = $folio_hover_style_class = $js_scripts = $anim_class = $mask_background = '';
