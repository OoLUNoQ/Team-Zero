				...
				vc_map(
					array(
						...
						'params'      => array(
							...
							array(
								'type'				=> 'dfd_single_checkbox',
								'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This options is not availabe if the option \'Hide element\' is enabled','dfd').'</span></span>'.esc_html__('Enable background decoration', 'dfd'),
...
//								'value'				=> '',
							...
							array(
								'type'				=> 'number',
								'heading'			=> esc_html__('Background sise', 'dfd'),
								'param_name'		=> 'bg_size',
		...
		function _dfd_testimonials_shortcode( $atts ) {
			...
			$output = $el_class = $module_animation = $enabled_bg_decor = $bg_size = $bg_border_radius = $bg_background = $animation_data = $uniqid = '';
