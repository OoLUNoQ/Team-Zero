...
Version: 1.0
*/
if(!class_exists('Dfd_Override_Ult_Parallax')){
	class Dfd_Override_Ult_Parallax {
		...
		function parallax_init(){
			...
			if(function_exists('vc_remove_param')){
				vc_remove_param('vc_row','bg_type');
				vc_remove_param('vc_row','bg_grad');
				vc_remove_param('vc_row','bg_color_value');
				vc_remove_param('vc_row','parallax_style');
				vc_remove_param('vc_row','bg_image_new');
				vc_remove_param('vc_row','layer_image');
				vc_remove_param('vc_row','bg_image_repeat');
				vc_remove_param('vc_row','bg_image_size');
				vc_remove_param('vc_row','bg_cstm_size');
				vc_remove_param('vc_row','bg_img_attach');
				vc_remove_param('vc_row','parallax_sense');
				vc_remove_param('vc_row','bg_image_posiiton');
				vc_remove_param('vc_row','animation_direction');
				vc_remove_param('vc_row','animation_repeat');
				vc_remove_param('vc_row','video_url');
				vc_remove_param('vc_row','video_url_2');
				vc_remove_param('vc_row','u_video_url');
				vc_remove_param('vc_row','video_opts');
				vc_remove_param('vc_row','video_poster');
				vc_remove_param('vc_row','u_start_time');
				vc_remove_param('vc_row','u_stop_time');
				vc_remove_param('vc_row','viewport_vdo');
				vc_remove_param('vc_row','enable_controls');
				vc_remove_param('vc_row','controls_color');
				vc_remove_param('vc_row','bg_override');
				vc_remove_param('vc_row','disable_on_mobile_img_parallax');
				vc_remove_param('vc_row','parallax_content');
				vc_remove_param('vc_row','parallax_content_sense');
				vc_remove_param('vc_row','fadeout_row');
				vc_remove_param('vc_row','fadeout_start_effect');
				vc_remove_param('vc_row','enable_overlay');
				vc_remove_param('vc_row','overlay_color');
				vc_remove_param('vc_row','overlay_pattern');
				vc_remove_param('vc_row','overlay_pattern_opacity');
				vc_remove_param('vc_row','overlay_pattern_size');
				vc_remove_param('vc_row','overlay_pattern_attachment');
				vc_remove_param('vc_row','multi_color_overlay');
				vc_remove_param('vc_row','multi_color_overlay_opacity');
			}
	...
	new Dfd_Override_Ult_Parallax;
}

if ( !function_exists( 'vc_theme_after_vc_row' ) ) {
	function vc_theme_after_vc_row($atts, $content = null) {
		return Dfd_Override_Ult_Parallax::parallax_shortcode($atts, $content);
	}
}
//}
